...
\title{Predicting vibrations of a cement mill with a deep learning algorithm\thanksref{footnoteinfo}} 
% Title, preferably not more than 10 words.

\thanks[footnoteinfo]{Sponsor acknowledgment to the company APODI by found and authorize this research.}

\author[First]{Manis Othon} 
\author[Second]{Alexandre Matos Arruda}
\author[Third]{Dmontier Pinheiro Arag\~{a}o, Jr.} 

\address[First]{Company Titan, Automation Manager, Address, Greece (e-mail: maniso@titan.gr)}
\address[Second]{Cear\'{a} Federal University, 
   Campus Russas, Address, Brazil (e-mail: aldufc@gmail.com)}
\address[Third]{Cear\'{a} Federal University, 
   Campus Russas, Address, Brazil (e-mail: dmontier.aragao@ufc.br)}

\begin{abstract}                % Abstract of not more than 250 words.
In the process of cement production, a critical problem is the occurrence of vibrations in the mill, these usually lead to stops in the production, and consequently in the reduction of the productivity. In order understand what lead to increasing vibrations, we have proposed a deep learning algorithm to predict the level of vibrations. This algorithm use production data of 3 months, reaching a mean absolute percentage error (MAPE) of less than 5\%. A good prediction of vibration is a crucial factor in taking measures to mitigate this problem, and consequently improves the productivity.
\end{abstract}

\begin{keyword}
Prediction. Vibration. Cement mill. Algorithms. Deep learning.
\end{keyword}
